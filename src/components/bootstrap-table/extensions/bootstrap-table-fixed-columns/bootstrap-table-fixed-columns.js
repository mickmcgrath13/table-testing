...
(function ($) {
    ...
    BootstrapTable.prototype.fitHeader = function () {
        ...
        this.fixedInitScroll();
    };


    BootstrapTable.prototype.fixedInitScroll = function(){
        var that = this;
        this.$tableBody.off('scroll.fixed-init-scroll').on('scroll.fixed-init-scroll', function () {
    ...
    BootstrapTable.prototype.fitBodyColumns = function () {
        ...
        if (!this.options.height) {
            ...
            //since box-sizing: border-box, add border
             height += parseInt(this.$el.css("border-top-width").replace("px", ""), 10);
             height += parseInt(this.$el.css("border-bottom-width").replace("px", ""), 10);
        }
